package week_1.controllers;


import week_1.DBConnection;
import week_1.modles.BookModel;
    ...
    public List<BookModel> getAllBooks() throws SQLException{
        ...
        try(Connection connection = DBConnection.connectDB();
            ...
            while(result.next()){
                ...
                BookModel newBook = new BookModel(book_id, title, author, isbn, categoryId, availabilityStatus);
                books.add(newBook);
            }
        }
        return books;
